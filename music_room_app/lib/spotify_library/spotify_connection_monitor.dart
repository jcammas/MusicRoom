...
class SpotifyConnectionMonitor extends StatefulWidget {
  ...
  static const String routeName = '/spotifyConnectionMonitor';

  @override
  _SpotifyConnectionMonitorState createState() =>
      _SpotifyConnectionMonitorState();
}

class _SpotifyConnectionMonitorState extends State<SpotifyConnectionMonitor> {
  bool _loading = false;
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<ConnectionStatus>(
      ...
      builder: (context, snapshot) {
        ...
        return Scaffold(
          appBar: AppBar(
            title: const Text('Spotify Connection Monitor'),
              ...
              children: <Widget>[
                ...
                TextButton(
                  ...
                  child: const Text('get auth token ',
                      style: TextStyle(color: Color(0XFF072BB8))),
                ),
              ],
            ),
            const Divider(),
  ...
  Future<void> play() async {
    try {
      await SpotifySdk.play(spotifyUri: 'spotify:track:1Nukcy7xk7AbS7MtkaiOe3');
    } on PlatformException catch (e) {
      setStatus(e.code, message: e.message);
    } on MissingPluginException {
      setStatus('not implemented');
